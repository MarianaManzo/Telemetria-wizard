// TODO: Replace /components/ModulesScreen.tsx with this content
...
const ModulesScreen = ({ 
  ...
  draftReports, 
  onToggleFavorite, 
  initialActiveSection = "templates", 
  onSectionChange 
}: ModulesScreenProps) => {
  ...
  return (
    <div className="h-screen bg-gray-50 flex flex-col">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <ReportsContent 
          onReportSelect={(reportId, reportName, savedReportData, draftReportData) => {
            onReportSelect(reportId, reportName, savedReportData, draftReportData, activeSection);
          }}
