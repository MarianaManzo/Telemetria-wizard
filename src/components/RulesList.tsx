...
export function RulesList({ rules, events, onRuleClick, onNewRule, onToggleFavorite, onEventClick, onStatusChange, onRename, onDelete, onDuplicate }: RulesListProps) {
  ...
  const rulesTableColumns: RulesTableColumnDefinition[] = [
    ...
    },
    {
      id: 'actions',
      label: 'Acciones',
      headerClassName: 'px-2 py-3 text-left text-[14px] font-medium text-gray-500 w-12 sticky right-0 bg-gray-50 shadow-[-4px_0_8px_rgba(0,0,0,0.15)] z-10 text-center',
      cellClassName: 'px-2 py-3 whitespace-nowrap text-[14px] text-gray-500 sticky right-0 bg-white shadow-[-4px_0_8px_rgba(0,0,0,0.15)] z-10',
      render: (rule) => (
