          ...
          <table className="w-full table-fixed min-w-[1000px]">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-2 py-2 text-center text-[14px] font-medium text-gray-500 sticky right-0 bg-gray-50 shadow-[-4px_0_8px_rgba(0,0,0,0.15)] after:absolute after:inset-y-0 after:left-0 after:w-[1px] after:bg-black/5 relative">Acciones</th>
              </tr>
            </thead>
              ...
              {filteredRules.map((rule) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-2 py-2 whitespace-nowrap text-[14px] text-gray-500 sticky right-0 bg-white shadow-[-4px_0_8px_rgba(0,0,0,0.15)] after:absolute after:inset-y-0 after:left-0 after:w-[1px] after:bg-black/5 relative">
