...
export const ModulesScreen = ({ onReportSelect, savedReports, draftReports, onToggleFavorite, initialActiveSection = 'templates', onSectionChange }: ModulesScreenProps) => {
