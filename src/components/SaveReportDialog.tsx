...
interface SaveReportDialogProps {
  ...
  onStay?: () => void;
  hasExistingSavedReport?: boolean; // New prop to differentiate modal types
  isDraftModal?: boolean; // New prop to determine if this is the draft modal or filters modal
  isDraftWithChanges?: boolean; // New prop to determine if this is specifically a draft with changes
}
...
export function SaveReportDialog({ 
  ...
  onExitWithoutSaving, 
  onStay, 
  hasExistingSavedReport = false,
  isDraftModal = true,
  isDraftWithChanges = false
}: SaveReportDialogProps) {
  
  // Use Figma design for draft modal with changes
  if (isDraftWithChanges) {
    return (
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="max-w-md p-0 gap-0" hideCloseButton={true}>
          <div className="bg-white box-border content-stretch flex flex-col items-start justify-start overflow-clip relative rounded-[8px] shadow-[0px_6px_16px_0px_rgba(0,0,0,0.08),0px_3px_6px_-4px_rgba(0,0,0,0.12),0px_9px_28px_8px_rgba(0,0,0,0.05)] size-full">
              ...
              <div className="flex flex-row items-center relative size-full">
                <div className="box-border content-stretch flex gap-3 items-center justify-start px-6 py-4 relative w-full">
                  ...
                  <div className="basis-0 font-['Source_Sans_3:SemiBold',_sans-serif] font-semibold grow leading-[0] min-h-px min-w-px relative shrink-0 text-[16px] text-[rgba(37,37,37,0.88)]">
                    <DialogTitle className="leading-[24px]">No has guardado el reporte</DialogTitle>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="relative shrink-0 w-full" data-name="Content Wrapper">
              <div className="flex flex-col justify-center relative size-full">
                <div className="box-border content-stretch flex flex-col gap-4 items-start justify-center px-6 py-3 relative w-full bg-[rgba(0,0,0,0)]">
                  <div className="font-['Source_Sans_3:Regular',_sans-serif] font-normal leading-[0] min-w-full relative shrink-0 text-[14px] text-black" style={{ width: "min-content" }}>
                    <DialogDescription className="leading-[22px]">
                      ¿Deseas guardarlo antes de salir?<br /><br />
                      Si decides no guardarlo, no te preocupes: aún podrás consultarlo más tarde en la sección <strong>"Borradores"</strong>.
                    </DialogDescription>
                  </div>
                </div>
              </div>
  ...
  // Use Figma design for filters modal
  if (!isDraftModal) {
    return (
      <Dialog open={open} onOpenChange={onOpenChange}>
            ...
            <div className="relative shrink-0 w-full" data-name="Head">
              <div className="flex flex-row items-center relative size-full">
                <div className="box-border content-stretch flex gap-3 items-center justify-start px-6 py-4 relative w-full">
                  <IconExclamationCircleFilled />
                  <div className="basis-0 font-['Source_Sans_3:SemiBold',_sans-serif] font-semibold grow leading-[0] min-h-px min-w-px relative shrink-0 text-[16px] text-[rgba(37,37,37,0.88)]">
                    <DialogTitle className="leading-[24px]">No se han guardado los cambios</DialogTitle>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="flex flex-col justify-center relative size-full">
                <div className="box-border content-stretch flex flex-col gap-4 items-start justify-center px-6 py-3 relative w-full">
                  <div className="font-['Source_Sans_3:Regular',_sans-serif] font-normal leading-[0] min-w-full relative shrink-0 text-[14px] text-[rgba(37,37,37,0.88)]" style={{ width: "min-content" }}>
                    <DialogDescription className="leading-[22px]">Al salir del reporte perderás los cambios que no han sido guardados. ¿Estás seguro que deseas salir del reporte?</DialogDescription>
                  </div>
                </div>
              </div>
            </div>
   ...
   // Use Figma design for draft modal too, but with draft-specific text
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md p-0 gap-0" hideCloseButton={true}>
        <div className="bg-white box-border content-stretch flex flex-col items-start justify-start overflow-clip relative rounded-[8px] shadow-[0px_6px_16px_0px_rgba(0,0,0,0.08),0px_3px_6px_-4px_rgba(0,0,0,0.12),0px_9px_28px_8px_rgba(0,0,0,0.05)] size-full">
